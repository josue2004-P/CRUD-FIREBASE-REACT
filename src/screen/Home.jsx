        ...
        <div className="p-6 text-gray-900">
          <div className="py-5">
            <div className="min-[422px]:flex min-[375px]:block min-[375px]:text-center min-[422px]:justify-between ">
              <h3 className="font-bold text-3xl min-[375px]:mb-5 min-[422px]:mb-0">Agregar Productos</h3>
              <Link to="/añadir" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
                Agregar productos
              </Link>
            </div>
          </div>
