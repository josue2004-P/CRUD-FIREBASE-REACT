...
export default function Productos({ producto }) {
  ...
  const handleBorrarCliente = () => {
    Swal.fire({
      title: "¿Estás seguro de que deseas borrar este cliente?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        clienteRef
          ...
          .catch((error) => {
            ...
            Swal.fire(
              "Error!",
              "Ocurrió un error al borrar el cliente.",
              "error"
            );
          });
      }
  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4 text-center flex text-lg">
        ...
        <button
          className=" bg-red-800 hover:bg-blue-700, inline-block mb-5 p-2 text-white uppercase font-bold"
